...
The `centralisedapproach` package also allwos users to create plots with the main results from the distirbutional exercise. 

To begin with, the LWS results must be saved your local repository as a csv file, so that the functions can import the relevant data.
